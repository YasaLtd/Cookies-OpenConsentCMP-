...
final class OpenConsent_CMP {
	...
	public static function defaults() {
		return array(
			...
			'google_signal_ad_storage' => 1,
			'google_signal_ad_user_data' => 1,
			'google_signal_ad_personalization' => 1,
			'google_signal_analytics_storage' => 1,
			'google_signal_functionality_storage' => 1,
			'google_signal_personalization_storage' => 1,
			'url_passthrough'       => 0,
